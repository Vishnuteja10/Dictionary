...
import vishnu.teja.dictionaryapp.ViewHolders.PhoneticViewHolder;
import vishnu.teja.dictionaryapp.models.Phonetics;
...
public class PhoneticsAdapter extends RecyclerView.Adapter<PhoneticViewHolder> {
    ...
    public PhoneticViewHolder onCreateViewHolder(@NonNull  ViewGroup parent, int viewType) {
        return new PhoneticViewHolder( LayoutInflater.from( context ).inflate( R.layout.phonetix_list_items,parent,false ) );
      ...
      holder.imageButton_audio.setOnClickListener( new View.OnClickListener() {
          ...
          public void onClick(View v) {
              ...
              try {
                  ...
                  e.printStackTrace();
                  Toast.makeText( context,"coudn,t play audio!",Toast.LENGTH_SHORT );
